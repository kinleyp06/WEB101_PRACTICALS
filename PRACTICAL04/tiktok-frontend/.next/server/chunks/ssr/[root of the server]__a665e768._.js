...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/login', {
            email,
            password
        });
    ...
    const register = async (username, email, password)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/register', {
            username,
            email,
            password
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a665e768._.js.map